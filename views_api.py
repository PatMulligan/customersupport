...
from . import nostr_client, customersupport_ext
from .crud import (
    create_customer,
...
@customersupport_ext.post("/api/v1/merchant")
...
@customersupport_ext.get("/api/v1/merchant")
...
@customersupport_ext.delete("/api/v1/merchant/{merchant_id}")
...
@customersupport_ext.put("/api/v1/merchant/{merchant_id}/nostr")
...
@customersupport_ext.get("/api/v1/merchant/{merchant_id}/nostr")
...
@customersupport_ext.put("/api/v1/merchant/{merchant_id}/toggle")
...
@customersupport_ext.delete("/api/v1/merchant/{merchant_id}/nostr")
async def api_delete_merchant(
    merchant_id: str,
    wallet: WalletTypeInfo = Depends(require_admin_key),
):
...
@customersupport_ext.get("/api/v1/zone")
...
@customersupport_ext.post("/api/v1/zone")
...
@customersupport_ext.patch("/api/v1/zone/{zone_id}")
...
@customersupport_ext.delete("/api/v1/zone/{zone_id}")
...
@customersupport_ext.post("/api/v1/stall")
...
@customersupport_ext.put("/api/v1/stall/{stall_id}")
...
@customersupport_ext.get("/api/v1/stall/{stall_id}")
...
@customersupport_ext.get("/api/v1/stall")
...
@customersupport_ext.get("/api/v1/stall/product/{stall_id}")
...
@customersupport_ext.get("/api/v1/stall/order/{stall_id}")
...
@customersupport_ext.delete("/api/v1/stall/{stall_id}")
...
@customersupport_ext.post("/api/v1/product")
...
@customersupport_ext.patch("/api/v1/product/{product_id}")
...
@customersupport_ext.get("/api/v1/product/{product_id}")
...
@customersupport_ext.delete("/api/v1/product/{product_id}")
...
@customersupport_ext.get("/api/v1/order/{order_id}")
...
@customersupport_ext.get("/api/v1/order")
...
@customersupport_ext.patch("/api/v1/order/{order_id}")
...
@customersupport_ext.put("/api/v1/order/restore/{event_id}")
...
@customersupport_ext.put("/api/v1/orders/restore")
...
@customersupport_ext.put("/api/v1/order/reissue")
...
@customersupport_ext.get("/api/v1/message/{public_key}")
...
@customersupport_ext.post("/api/v1/message")
async def api_create_message(
    data: PartialDirectMessage, wallet: WalletTypeInfo = Depends(require_admin_key)
) -> DirectMessage:
    try:
        # 2) get the merchant from the extension database
        merchant = await get_merchant_for_user(wallet.wallet.user)
        assert merchant, f"Merchant cannot be found"

        # 3) use the merchant idea to build_dm_event (partial direct message)
...
@customersupport_ext.get("/api/v1/customer")
...
@customersupport_ext.post("/api/v1/customer")
...
@customersupport_ext.get("/api/v1/currencies")
async def api_list_currencies_available():
    return list(currencies.keys())


@customersupport_ext.put("/api/v1/restart")
